...
pub trait IKidsViewerPiggyBank<CS> {
    fn receive_reward(ref self: CS, child: ContractAddress, token: ContractAddress, amount: u256);
    fn request_withdrawal(ref self: CS, token: ContractAddress, amount: u256, reason: felt252);
    fn approve_withdrawal(ref self: CS, request_id: u64);
    fn reject_withdrawal(ref self: CS, request_id: u64, reason: felt252);
    fn invest_in_aave(
        ref self: CS, token: ContractAddress, amount: u256, aave_product: ContractAddress,
    );
    fn recover_all_investments(ref self: CS, child: ContractAddress, token: ContractAddress);
    fn set_parent_approval(ref self: CS, child: ContractAddress, approved: bool);
    fn set_investment_config(ref self: CS, child: ContractAddress, enabled: bool, max_amount: u256);
    fn set_aave_product_approval(
        ref self: CS, child: ContractAddress, aave_product: ContractAddress, approved: bool,
    );
    fn set_child_active(ref self: CS, child: ContractAddress, active: bool);
    fn pause(ref self: CS);
    fn unpause(ref self: CS);
    fn get_child_balance(self: @CS, child: ContractAddress, token: ContractAddress) -> u256;
    fn get_child_earnings(
        self: @CS, child: ContractAddress, token: ContractAddress,
    ) -> (u256, u256);
    fn get_withdrawal_request(
        self: @CS, request_id: u64,
    ) -> (ContractAddress, ContractAddress, u256, felt252, bool, bool, felt252);
    fn get_child_withdrawal_requests(self: @CS, child: ContractAddress) -> u64;
    fn get_investment_config(self: @CS, child: ContractAddress) -> (bool, u256, u256);
    fn is_aave_product_approved(
        self: @CS, child: ContractAddress, aave_product: ContractAddress,
    ) -> bool;
    fn is_parent_approved(self: @CS, parent: ContractAddress, child: ContractAddress) -> bool;
    fn is_child_active(self: @CS, child: ContractAddress) -> bool;
    fn paused(self: @CS) -> bool;
    fn owner(self: @CS) -> ContractAddress;
    fn next_request_id(self: @CS) -> u64;
    fn child_balances(self: @CS, child: ContractAddress, token: ContractAddress) -> u256;
    fn child_earnings(self: @CS, child: ContractAddress, token: ContractAddress) -> u256;
    fn child_request_ids(self: @CS, child: ContractAddress) -> u64;
    fn parent_approvals(self: @CS, parent: ContractAddress, child: ContractAddress) -> bool;
