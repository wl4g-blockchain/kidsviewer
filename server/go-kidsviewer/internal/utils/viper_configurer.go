...
// ExistsFileOrDir checks if a file or directory exists
func ExistsFileOrDir(path string) bool {
	_, err := os.Stat(path)
	return !os.IsNotExist(err)
}

// CreateWriteTmpFile creates a temporary file with the given content
func CreateWriteTmpFile(filename, content string) (string, error) {
