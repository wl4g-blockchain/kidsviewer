...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/auth/verify-parental-password": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.VerifyPasswordRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/persons/{id}": {
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid user ID or person ID",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Person update request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/persons/{id}/learning-progress": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Failed to get learning progress",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/v1/persons/{id}/platforms": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Person platforms retrieved successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "500": {
                        "description": "Failed to get person platforms",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/v1/persons/{id}/settings": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Person settings update request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpdatePersonSettingsRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Person settings updated successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "500": {
                        "description": "Failed to update person settings",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/v1/persons/{id}/statistics": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Failed to get person statistics",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/v1/platforms": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Failed to get platforms",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Platform creation request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/platforms/{id}": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Failed to get platform",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "put": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request data or platform ID",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/v1/questions": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Limit number of questions (default: 0 for all)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.QuestionTemplate"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/questions/{id}": {
            ...
            "put": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request data or question ID",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/v1/settings": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Failed to get app settings",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/v1/settings/app-info": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Failed to get app info",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/v1/watching/check": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Check watching request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/services.CheckWatchingRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Watching session status retrieved successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "500": {
                        "description": "Failed to check watching session",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/v1/watching/history/{person_id}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Limit number of sessions (default: 50)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Watching history retrieved successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "500": {
                        "description": "Failed to get watching history",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/v1/watching/skip": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Skip questions request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/services.SkipQuestionsRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Questions skipped successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "401": {
                        "description": "Unauthorized - parental password required",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "500": {
                        "description": "Failed to skip questions",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/v1/watching/start": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Start watching request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/services.StartWatchingRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Watching session started successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "500": {
                        "description": "Failed to start watching session",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/v1/watching/verify": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Question verification request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/services.VerifyQuestionRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Question verification completed successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "404": {
                        "description": "Watching session not found",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
    ...
    "definitions": {
        ...
        "models.Platform": {
            ...
            "properties": {
                "ageGroups": {
                    "description": "JSON array of age groups",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "models.UpdatePersonSettingsRequest": {
            "type": "object",
            "properties": {
                "difficulty": {
                    "type": "string"
        ...
        "services.VerifyQuestionRequest": {
            "type": "object",
            "required": [
                "answer",
                "question_id",
