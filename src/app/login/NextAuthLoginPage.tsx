...
import { useSession, useSessionData } from '@/components/auth/AuthProvider';
...
// Main login component without Web3 dependencies
...
}> = ({ openAuthModal, wagmiAddress, wagmiIsConnected, wagmiChainId, signMessageAsync }) => {
...
// Main component with Web3 wrapper
export const NextAuthLoginPage: React.FC = () => {
  return (
    <Web3AuthWrapper>
      {(web3Auth) => (
        <LoginPageContent
          openAuthModal={web3Auth.openAuthModal}
          wagmiAddress={web3Auth.wagmiAddress}
          wagmiIsConnected={web3Auth.wagmiIsConnected}
          wagmiChainId={web3Auth.wagmiChainId}
          signMessageAsync={web3Auth.signMessageAsync}
        />
      )}
    </Web3AuthWrapper>
  );
