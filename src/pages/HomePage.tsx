...
export const HomePage: React.FC = () => {
  ...
  const features = [
    ...
    {
      icon: Trophy,
      title: t("person.accuracy"),
      description: t("person.score"),
  ...
  const quickActions = [
    {
      title: t("navigation.parental"),
      description: t("parental.dashboard"),
      href: "/parental",
      icon: Users,
      color: "bg-blue-500 hover:bg-blue-600",
    },
    {
      title: t("navigation.person"),
      description: t("person.viewer"),
      href: "/person",
      icon: Video,
    ...
    },
    {
      ...
      description: t("parental.settings"),
      href: "/settings",
      icon: Settings,
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {quickActions.map((action, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`inline-flex items-center justify-center w-16 h-16 rounded-full ${action.color} text-white mb-4`}
                >
                  <Icon className="w-8 h-8" />
                </div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Create a profile for each child with their age and preferences
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Set time limits, question types, and allowed video platforms
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Track learning progress and daily usage reports
                </p>
              </div>
            </div>
          </div>
